        ...
        setRestaurants((prev) =>
          prev.map((r) =>
            String(r.id) === String(updated.id)
              ? { ...r, isFavorite: updated.is_favorite ?? !r.isFavorite }
              : r
          )
        );
      });
          ...
          <div style={{ display: isAddModalOpen ? "none" : "block" }}>
            ...
            <div className="flex justify-center -mt-2">
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold rounded-full shadow-lg hover:scale-105 hover:shadow-xl transition-all"
              >
                {t.app.addRestaurant}
              </button>
            </div>
            ...
            {selectedRestaurant && (
              <div
                ...
                className="max-w-4xl mx-auto my-8 p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg flex flex-col items-center"
              >
                <img
                  src={selectedRestaurant.photoUrl}
                  alt={selectedRestaurant.name}
                  className="w-full max-w-2xl h-96 object-cover rounded-lg mb-6 shadow-lg"
                />
